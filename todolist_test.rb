...
class TodoListTest < Minitest::Test
  ...
  def test_not_done_question
    assert(true, @todo1.not_done?)
  end
  ...
  def test_all_done
    ...
    assert_equal(done_todos.to_a, [@todo1, @todo3])
  end

  def test_all_not_done
    @todo1.done!
    undone_todos = @list.all_not_done
    assert_equal(undone_todos.to_a, [@todo2, @todo3])
  end
  ...
  def test_mark_all_undone
    ...
    assert_equal(true, @todo2.not_done?)
    assert_equal(true, @todo3.not_done?)
  end
end
